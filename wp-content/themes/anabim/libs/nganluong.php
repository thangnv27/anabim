...
class NL_Checkout {
    ...
    // Mã merchante site 
    private $merchant_site_code = '31930'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site
    // Mật khẩu bảo mật
    private $secure_pass = 'ppovn123'; // Biến này được nganluong.vn cung cấp khi bạn đăng ký merchant site
...
if(!function_exists("nganluong_init")){
    function nganluong_init(){
        global $nl_checkout;
        $merchant_site_code = get_option("nl_merchantID");
        $secure_pass = get_option("nl_merchantPWD");
