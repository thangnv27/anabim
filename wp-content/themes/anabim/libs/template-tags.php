    ...
    <nav class="navigation post-navigation" role="navigation">
        ...
        <div class="nav-links">
            ...
            if ( is_attachment() ) :
                ...
                previous_post_link( '%link', __( '<span class="meta-nav">&Lt; Bài trước: </span> %title', SHORT_NAME ) );
                next_post_link( '%link', __( '<span class="meta-nav">&Gt; Bài tiếp: </span> %title', SHORT_NAME ) );
            endif;
            ?>
        </div><!-- .nav-links -->
    </nav><!-- .navigation -->
...
function ppo_posted_on() {
    if ( is_sticky() && is_home() && ! is_paged() ) {
        echo '<span class="featured-post">' . __( 'Bài nổi bật', SHORT_NAME ) . '</span>';
    }
