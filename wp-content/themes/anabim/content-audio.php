...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <header class="entry-header">
        ...
        if (is_single()) :
            ...
            the_title('<h3 class="entry-title"><a href="' . esc_url(get_permalink()) . '" rel="bookmark"><i class="fa fa-file-audio-o"></i> ', '</a></h3>');
        endif;
        ?>
    ...
    <div class="entry-content">
        ...
        the_content(sprintf(
                        __('Xem thêm %s <span class="meta-nav">&rarr;</span>', SHORT_NAME), the_title('<span class="screen-reader-text">', '</span>', false)
        ));
